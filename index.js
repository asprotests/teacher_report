...
app.get("/quran-teacher-report/survey", authenticateToken, async (req, res) => {
  ...
  try {
    ...
    const resultMap = {
      ...
      11: { agent: agentMap[11], android: 0, ios: 0 },
      12: { agent: agentMap[12], android: 0, ios: 0 },
      13: { agent: agentMap[13], android: 0, ios: 0 },
      14: { agent: agentMap[14], android: 0, ios: 0 },
      15: { agent: agentMap[15], android: 0, ios: 0 },
      16: { agent: agentMap[16], android: 0, ios: 0 },
      17: { agent: agentMap[17], android: 0, ios: 0 },
      18: { agent: agentMap[18], android: 0, ios: 0 },
      19: { agent: agentMap[19], android: 0, ios: 0 },
      20: { agent: agentMap[20], android: 0, ios: 0 },
      21: { agent: agentMap[21], android: 0, ios: 0 },
      22: { agent: agentMap[22], android: 0, ios: 0 },
      23: { agent: agentMap[23], android: 0, ios: 0 },
      24: { agent: agentMap[24], android: 0, ios: 0 },
      25: { agent: agentMap[25], android: 0, ios: 0 },
      26: { agent: agentMap[26], android: 0, ios: 0 },
      27: { agent: agentMap[27], android: 0, ios: 0 },
      28: { agent: agentMap[28], android: 0, ios: 0 },
      29: { agent: agentMap[29], android: 0, ios: 0 },
      30: { agent: agentMap[30], android: 0, ios: 0 },
      31: { agent: agentMap[31], android: 0, ios: 0 },
      32: { agent: agentMap[32], android: 0, ios: 0 },
      33: { agent: agentMap[33], android: 0, ios: 0 },
      34: { agent: agentMap[34], android: 0, ios: 0 },
